(function() {
  ...
  (function($) {
    ...
    test('#generateAncestor', function() {
      ...
      deepEqual(fdiv().find("#test-list a:eq(2)").selectorator().generateAncestor(), [".link-yahoo", ".link-yahoo", ".link-yahoo", ".link-yahoo", ".link-yahoo", ".link-yahoo"]);
    ...
    test('#generate', function() {
      ...
      return deepEqual(fdiv().find("#test-list a:eq(3)").selectorator().generate(), ["a[name='google']"]);
    });
    return test('all elements', function() {
      return $("*").each(function() {
        var selectors;
        selectors = $(this).selectorator().generate();
